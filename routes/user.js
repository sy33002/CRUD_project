...
router.get('/manager/allConference', controller.getAllConference); // 관리자 페이지 전체 컨퍼런스 목록들 render
router.get('/manager/getConferenceRegister', controller.getConforenceRegister); // 관리자 페이지 승인할 컨퍼런스 목록들
router.get('/manager/conferenceHandler', controller.getconferenceHandler); // 관리자 페이지 행사 관리 페이지 render
